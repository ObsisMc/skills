...
| [gh-daily-work-journal](../skills/gh-daily-work-journal/SKILL.md) | - | 仅显式调用 | 汇总完整 GitHub 活动与跨日推送、合入进展（含 commit 搜索看不到的特性分支提交），并结合代码和项目背景生成带来源链接、按项目分组归类、突出成果、难点、项目位置、价值与下一步的中文工作日记 |
